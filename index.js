...
perguntas = [
    {
      pergunta: "Qual é o pokemon do Ash?",
      respostas: [
    ...
    {
        pergunta: "Qual é o principal vilão de Pokémon?",
        respostas: [
            { opcao: "Team Rocket", correto: true },
            { opcao: "Team Magma", correto: false },
            { opcao: "Team Aqua", correto: false },
            { opcao: "Team Galactic", correto: false },
        ],
    },
    {
